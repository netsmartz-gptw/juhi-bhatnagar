...
const ReceiptPreview = (props) => {
    ...
    const [transactionEmail, setTransactionEmail] = useState(state.settingsData.contact.email || '')
                ...
                .then(
                    (response) => {
                        ...
                        if (props.transaction.patientId) {
                            setSelectedPatient(patientList.find(obj => obj.id === props.transaction.patientId))
                        }
                        else if (invoice.patiendId) {
                            setSelectedPatient(patientList.find(obj => obj.id === invoice.patientId))
                        }
                        else {
    ...
    return (
        <div className='container mb-3'>
            {invoice && <div className='row d-flex'>
                ...
                <div className='col-12 mt-3 px-0 card' id="recepit">
